...
import 'package:signup1/Admin/AddDocument.dart';
...
class MyCourseDetailsAdmin extends StatefulWidget {
  const MyCourseDetailsAdmin({Key? key}) : super(key: key);

  @override
  State<MyCourseDetailsAdmin> createState() => _MyCourseDetailsAdminState();
}

class _MyCourseDetailsAdminState extends State<MyCourseDetailsAdmin> {
                          ...
                          children: [
                            ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => const AddDocumentAdmin()),
                                  );
                                },
